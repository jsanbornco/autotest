    ...
    <div class="ad-hero">
      <div class="fixed-hero-container">
        <a id="storyplate-<%= AD_ID %>-hero-redirect" target="_blank" href="<%= CLICK_MACRO %>">
          <img class="ad-hero-img" src="https://storyplate.imgix.net/ads/motorola/img/hero_test2.jpg<%= HERO_IMAGE_ARGS %>" />
          <img class="ad-hero-img-mobile" src="https://storyplate.imgix.net/ads/motorola/img/hero_mobile_test.jpg<%= HERO_IMAGE_ARGS %>" />
        </a>
      </div>
    </div>

...
<body>
  <div class="homepage-ad-video storyplate" id="<%= AD_ID %>">
    ...
    <div class="text-overlay">
      ...
      <a class="cta-read" id="storyplate-<%= AD_ID %>-cta-redirect" href="<%= CLICK_MACRO_2 %>" target="_blank"><%= BUTTON_COPY %></a>
      <div></div>
      <a class="cta-read cta2" id="storyplate-<%= AD_ID %>-cta2-redirect" href="<%= CLICK_MACRO %>" target="_blank"><%= BUTTON2_COPY %></a>


      <div class="sponsor">
        <img class="storyplate-presented" src="<%= STATIC_URL %>/img/presented-by_black.svg" />
    ...
    <div class="ad-hero">
      <div class="fixed-hero-container">
        <a id="storyplate-<%= AD_ID %>-hero-redirect" target="_blank" href="<%= CLICK_MACRO %>">
          <img class="ad-hero-img" src="https://storyplate.imgix.net/ads/triscuit2/img/hero3.jpg<%= HERO_IMAGE_ARGS %>" />
        </a>
      </div>
    </div>
